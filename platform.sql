...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('PlatformScheduler', 'SiZhenTao1519197581312', '1519204159536', '15000');
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('02c440ee1c1141aba7efd37ea0049489', '\"admin\"', 'com.siztao.framework.admin.controller.SysLoginController.login()', '用户登录', '\"admin\"', '127.0.0.1', '2018-02-21 16:37:51');
INSERT INTO `sys_log` VALUES ('68fed08dcf524233b7078025993f80cc', '\"admin\"', 'com.siztao.framework.admin.controller.SysLoginController.login()', '用户登录', '\"admin\"', '127.0.0.1', '2018-02-21 23:06:16');
INSERT INTO `sys_log` VALUES ('6d5ee9f80c0a4256aaa384dc7c82978c', 'admin', 'com.siztao.framework.admin.controller.SysRoleController.delete()', '删除角色', '[\"6a9f76de20a944059dca5e2ae90d780d\"]', '127.0.0.1', '2018-02-21 16:38:03');
INSERT INTO `sys_log` VALUES ('861f5cb99fd340c5a1a56f3e8a0be3ec', '\"admin\"', 'com.siztao.framework.admin.controller.SysLoginController.login()', '用户登录', '\"admin\"', '127.0.0.1', '2018-02-21 23:01:37');
INSERT INTO `sys_log` VALUES ('900aaff796eb40d09f07b83daa61b044', 'admin', 'com.siztao.framework.admin.controller.SysRoleController.save()', '保存角色', '{\"deptId\":\"0106\",\"deptIdList\":[\"0102\",\"0106\"],\"deptName\":\"合肥分公司\",\"menuIdList\":[],\"roleName\":\"dd\"}', '127.0.0.1', '2018-02-21 16:43:30');
INSERT INTO `sys_log` VALUES ('f2fd62f89d374a3f970cd35b2ac17fda', '\"admin\"', 'com.siztao.framework.admin.controller.SysLoginController.login()', '用户登录', '\"admin\"', '127.0.0.1', '2018-02-21 22:46:01');
...
INSERT INTO `sys_role` VALUES ('b624f6a23bec4eb1a5320b99e882b1f8', 'dd', '0106', null, '1', '2018-02-21 16:43:30', null, null);
...
INSERT INTO `sys_role_dept` VALUES ('4aad545816e311e8bc72b025aa1452b3', 'b624f6a23bec4eb1a5320b99e882b1f8', '0102');
INSERT INTO `sys_role_dept` VALUES ('4aad561316e311e8bc72b025aa1452b3', 'b624f6a23bec4eb1a5320b99e882b1f8', '0106');
